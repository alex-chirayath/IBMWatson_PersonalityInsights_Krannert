...
def speechanalysis(audio_filename):
    ...
    speaker_data = getspeech(audio_filename)

    # Get list of words associated with interviewee
    interviewee_words = getintervieweewords(speaker_data)

    # TODO: save text files somewhere better or not at all
    text_file_name = audio_filename.replace('.mp3', '')  + '.txt'
